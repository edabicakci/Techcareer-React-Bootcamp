...
//    if (date.getFullYear() === 1998 && date.getMonth() === 4){
//     console.log(order);
//     }
//   });
...
//     && new Date(order.orderDate).getMonth() === 4 ) {
//         console.log(order)
//     }
// });
...
//             total = total + detail.unitPrice * detail.quantity)
...
//         if (result) {
//             const item = customerTotalPrice.find(q => q.id === order.customerId).totalPrice += +totalOrderPrice
//             console.log(item);
...
// worstCustomer = customerTotalPrice.sort((a,b) => a.totalPrice-b.totalPrice)[0]
...
//   orders.forEach((order) => {
//     if (order.details){
//         const arr = orders.filter(second => order.customerId === second.customerId);
//         let total = 0;
//         arr.forEach(ele => {
//             if(ele.details){
